...
Namespace Software
	...
	Public Partial Class FormTwo
		...
		' Token: 0x06000077 RID: 119 RVA: 0x0001C6D0 File Offset: 0x0001A8D0
		Public Sub New()
		...
		' Token: 0x06000078 RID: 120 RVA: 0x0001FCC8 File Offset: 0x0001DEC8
		...
		' Token: 0x06000079 RID: 121 RVA: 0x0001FD54 File Offset: 0x0001DF54
		Private Sub FormTwo_Load(sender As Object, e As EventArgs)
		End Sub

		' Token: 0x0600007A RID: 122 RVA: 0x0001FD58 File Offset: 0x0001DF58
		...
		' Token: 0x0600007B RID: 123 RVA: 0x0001FDD0 File Offset: 0x0001DFD0
		Private Sub btnStart_Click(sender As Object, e As EventArgs)
			...
			If checkedCount > 2 Then
				MessageBox.Show("Your version only supports 2 blockchain.", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
				Return
			End If
			Me.isMining = True
		...
		' Token: 0x0600007C RID: 124 RVA: 0x0001FEA0 File Offset: 0x0001E0A0
		Private Sub btnStop_Click(sender As Object, e As EventArgs)
			Dim <btnStop_Click>d__ As FormTwo.<btnStop_Click>d__12
			<btnStop_Click>d__.<>t__builder = AsyncVoidMethodBuilder.Create()
			<btnStop_Click>d__.<>4__this = Me
			<btnStop_Click>d__.<>1__state = -1
			<btnStop_Click>d__.<>t__builder.Start(Of FormTwo.<btnStop_Click>d__12)(<btnStop_Click>d__)
		End Sub

		' Token: 0x0600007D RID: 125 RVA: 0x0001FED8 File Offset: 0x0001E0D8
		Private Sub StartMining(token As CancellationToken)
			Dim <StartMining>d__ As FormTwo.<StartMining>d__13
			...
			<StartMining>d__.<>t__builder.Start(Of FormTwo.<StartMining>d__13)(<StartMining>d__)
		End Sub

		' Token: 0x0600007E RID: 126 RVA: 0x0001FF17 File Offset: 0x0001E117
		Private Sub textBoxOutput_TextChanged(sender As Object, e As EventArgs)
		End Sub

		' Token: 0x0600007F RID: 127 RVA: 0x0001FF19 File Offset: 0x0001E119
		Private Sub DisplayCounter(counter As Integer)
			Me.lblCounter.Text = String.Format("Checked: {0}", counter)
		End Sub

		' Token: 0x06000080 RID: 128 RVA: 0x0001FF36 File Offset: 0x0001E136
		Private Sub button1_Click(sender As Object, e As EventArgs)
			New info().Show()
		End Sub

		' Token: 0x06000081 RID: 129 RVA: 0x0001FF42 File Offset: 0x0001E142
