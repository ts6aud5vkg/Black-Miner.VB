...
Namespace Software
	...
	Public Partial Class FormThree
		Inherits Form

		' Token: 0x06000069 RID: 105 RVA: 0x000181C4 File Offset: 0x000163C4
		Public Sub New()
		...
		' Token: 0x0600006A RID: 106 RVA: 0x0001B7BC File Offset: 0x000199BC
		...
		' Token: 0x0600006B RID: 107 RVA: 0x0001B848 File Offset: 0x00019A48
		Private Sub FormThree_Load(sender As Object, e As EventArgs)
		End Sub

		' Token: 0x0600006C RID: 108 RVA: 0x0001B84C File Offset: 0x00019A4C
		...
		' Token: 0x0600006D RID: 109 RVA: 0x0001B8C4 File Offset: 0x00019AC4
		Private Sub btnStart_Click(sender As Object, e As EventArgs)
			...
			If checkedCount > 3 Then
				MessageBox.Show("Your version only supports 3 blockchain.", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
				Return
			End If
			Me.isMining = True
		...
		' Token: 0x0600006E RID: 110 RVA: 0x0001B994 File Offset: 0x00019B94
		Private Sub btnStop_Click(sender As Object, e As EventArgs)
			Dim <btnStop_Click>d__ As FormThree.<btnStop_Click>d__12
			<btnStop_Click>d__.<>t__builder = AsyncVoidMethodBuilder.Create()
			<btnStop_Click>d__.<>4__this = Me
			<btnStop_Click>d__.<>1__state = -1
			<btnStop_Click>d__.<>t__builder.Start(Of FormThree.<btnStop_Click>d__12)(<btnStop_Click>d__)
		End Sub

		' Token: 0x0600006F RID: 111 RVA: 0x0001B9CC File Offset: 0x00019BCC
		Private Sub StartMining(token As CancellationToken)
			Dim <StartMining>d__ As FormThree.<StartMining>d__13
			...
			<StartMining>d__.<>t__builder.Start(Of FormThree.<StartMining>d__13)(<StartMining>d__)
		End Sub

		' Token: 0x06000070 RID: 112 RVA: 0x0001BA0B File Offset: 0x00019C0B
		Private Sub textBoxOutput_TextChanged(sender As Object, e As EventArgs)
		End Sub

		' Token: 0x06000071 RID: 113 RVA: 0x0001BA0D File Offset: 0x00019C0D
		Private Sub DisplayCounter(counter As Integer)
			Me.lblCounter.Text = String.Format("Checked: {0}", counter)
		End Sub

		' Token: 0x06000072 RID: 114 RVA: 0x0001BA2A File Offset: 0x00019C2A
		Private Sub button1_Click(sender As Object, e As EventArgs)
			New info().Show()
		End Sub

		' Token: 0x06000073 RID: 115 RVA: 0x0001BA36 File Offset: 0x00019C36
