...
Namespace Software
	...
	Public Partial Class FormSix
		Inherits Form

		' Token: 0x0600005B RID: 91 RVA: 0x00013CB8 File Offset: 0x00011EB8
		Public Sub New()
		...
		' Token: 0x0600005C RID: 92 RVA: 0x000172B0 File Offset: 0x000154B0
		...
		' Token: 0x0600005D RID: 93 RVA: 0x0001733C File Offset: 0x0001553C
		Private Sub FormSix_Load(sender As Object, e As EventArgs)
		End Sub

		' Token: 0x0600005E RID: 94 RVA: 0x00017340 File Offset: 0x00015540
		...
		' Token: 0x0600005F RID: 95 RVA: 0x000173B8 File Offset: 0x000155B8
		Private Sub btnStart_Click(sender As Object, e As EventArgs)
			...
			If checkedCount = 0 Then
				...
				Return
			End If
			If checkedCount > 6 Then
				MessageBox.Show("Your version only supports 6 blockchain.", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
				Return
			End If
			Me.isMining = True
		...
		' Token: 0x06000060 RID: 96 RVA: 0x00017488 File Offset: 0x00015688
		Private Sub btnStop_Click(sender As Object, e As EventArgs)
			Dim <btnStop_Click>d__ As FormSix.<btnStop_Click>d__12
			<btnStop_Click>d__.<>t__builder = AsyncVoidMethodBuilder.Create()
			<btnStop_Click>d__.<>4__this = Me
			<btnStop_Click>d__.<>1__state = -1
			<btnStop_Click>d__.<>t__builder.Start(Of FormSix.<btnStop_Click>d__12)(<btnStop_Click>d__)
		End Sub

		' Token: 0x06000061 RID: 97 RVA: 0x000174C0 File Offset: 0x000156C0
		Private Sub StartMining(token As CancellationToken)
			Dim <StartMining>d__ As FormSix.<StartMining>d__13
			...
			<StartMining>d__.<>t__builder.Start(Of FormSix.<StartMining>d__13)(<StartMining>d__)
		End Sub

		' Token: 0x06000062 RID: 98 RVA: 0x000174FF File Offset: 0x000156FF
		Private Sub textBoxOutput_TextChanged(sender As Object, e As EventArgs)
		End Sub

		' Token: 0x06000063 RID: 99 RVA: 0x00017501 File Offset: 0x00015701
		Private Sub DisplayCounter(counter As Integer)
			Me.lblCounter.Text = String.Format("Checked: {0}", counter)
		End Sub

		' Token: 0x06000064 RID: 100 RVA: 0x0001751E File Offset: 0x0001571E
		Private Sub button1_Click(sender As Object, e As EventArgs)
			New info().Show()
		End Sub

		' Token: 0x06000065 RID: 101 RVA: 0x0001752A File Offset: 0x0001572A
