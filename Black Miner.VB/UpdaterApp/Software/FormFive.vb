...
Namespace Software
	...
	Public Partial Class FormFive
		...
		' Token: 0x06000023 RID: 35 RVA: 0x00006890 File Offset: 0x00004A90
		Public Sub New()
		...
		' Token: 0x06000024 RID: 36 RVA: 0x00009E88 File Offset: 0x00008088
		...
		' Token: 0x06000025 RID: 37 RVA: 0x00009F14 File Offset: 0x00008114
		Private Sub FormFive_Load(sender As Object, e As EventArgs)
		End Sub

		' Token: 0x06000026 RID: 38 RVA: 0x00009F18 File Offset: 0x00008118
		...
		' Token: 0x06000027 RID: 39 RVA: 0x00009F90 File Offset: 0x00008190
		Private Sub btnStart_Click(sender As Object, e As EventArgs)
			...
			If checkedCount > 5 Then
				MessageBox.Show("Your version only supports 5 blockchain.", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
				Return
			End If
			Me.isMining = True
		...
		' Token: 0x06000028 RID: 40 RVA: 0x0000A060 File Offset: 0x00008260
		Private Sub btnStop_Click(sender As Object, e As EventArgs)
			Dim <btnStop_Click>d__ As FormFive.<btnStop_Click>d__12
			<btnStop_Click>d__.<>t__builder = AsyncVoidMethodBuilder.Create()
			<btnStop_Click>d__.<>4__this = Me
			<btnStop_Click>d__.<>1__state = -1
			<btnStop_Click>d__.<>t__builder.Start(Of FormFive.<btnStop_Click>d__12)(<btnStop_Click>d__)
		End Sub

		' Token: 0x06000029 RID: 41 RVA: 0x0000A098 File Offset: 0x00008298
		Private Sub StartMining(token As CancellationToken)
			Dim <StartMining>d__ As FormFive.<StartMining>d__13
			...
			<StartMining>d__.<>t__builder.Start(Of FormFive.<StartMining>d__13)(<StartMining>d__)
		End Sub

		' Token: 0x0600002A RID: 42 RVA: 0x0000A0D7 File Offset: 0x000082D7
		Private Sub textBoxOutput_TextChanged(sender As Object, e As EventArgs)
		End Sub

		' Token: 0x0600002B RID: 43 RVA: 0x0000A0D9 File Offset: 0x000082D9
		Private Sub DisplayCounter(counter As Integer)
			Me.lblCounter.Text = String.Format("Checked: {0}", counter)
		End Sub

		' Token: 0x0600002C RID: 44 RVA: 0x0000A0F6 File Offset: 0x000082F6
		Private Sub button1_Click(sender As Object, e As EventArgs)
			New info().Show()
		End Sub

		' Token: 0x0600002D RID: 45 RVA: 0x0000A102 File Offset: 0x00008302
