...
Namespace Software
	...
	Public Partial Class FormOne
		...
		' Token: 0x0600004D RID: 77 RVA: 0x0000F7AC File Offset: 0x0000D9AC
		Public Sub New()
		...
		' Token: 0x0600004E RID: 78 RVA: 0x00012DA4 File Offset: 0x00010FA4
		...
		' Token: 0x0600004F RID: 79 RVA: 0x00012E30 File Offset: 0x00011030
		Private Sub FormOne_Load(sender As Object, e As EventArgs)
		End Sub

		' Token: 0x06000050 RID: 80 RVA: 0x00012E34 File Offset: 0x00011034
		...
		' Token: 0x06000051 RID: 81 RVA: 0x00012EAC File Offset: 0x000110AC
		Private Sub btnStart_Click(sender As Object, e As EventArgs)
			...
			If checkedCount > 1 Then
				MessageBox.Show("Your version only supports 1 blockchain.", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
				Return
			End If
			Me.isMining = True
		...
		' Token: 0x06000052 RID: 82 RVA: 0x00012F7C File Offset: 0x0001117C
		Private Sub btnStop_Click(sender As Object, e As EventArgs)
			Dim <btnStop_Click>d__ As FormOne.<btnStop_Click>d__12
			<btnStop_Click>d__.<>t__builder = AsyncVoidMethodBuilder.Create()
			<btnStop_Click>d__.<>4__this = Me
			<btnStop_Click>d__.<>1__state = -1
			<btnStop_Click>d__.<>t__builder.Start(Of FormOne.<btnStop_Click>d__12)(<btnStop_Click>d__)
		End Sub

		' Token: 0x06000053 RID: 83 RVA: 0x00012FB4 File Offset: 0x000111B4
		Private Sub StartMining(token As CancellationToken)
			Dim <StartMining>d__ As FormOne.<StartMining>d__13
			...
			<StartMining>d__.<>t__builder.Start(Of FormOne.<StartMining>d__13)(<StartMining>d__)
		End Sub

		' Token: 0x06000054 RID: 84 RVA: 0x00012FF3 File Offset: 0x000111F3
		Private Sub textBoxOutput_TextChanged(sender As Object, e As EventArgs)
		End Sub

		' Token: 0x06000055 RID: 85 RVA: 0x00012FF5 File Offset: 0x000111F5
		Private Sub DisplayCounter(counter As Integer)
			Me.lblCounter.Text = String.Format("Checked: {0}", counter)
		End Sub

		' Token: 0x06000056 RID: 86 RVA: 0x00013012 File Offset: 0x00011212
		Private Sub button1_Click(sender As Object, e As EventArgs)
			New info().Show()
		End Sub

		' Token: 0x06000057 RID: 87 RVA: 0x0001301E File Offset: 0x0001121E
